...
var ukeys = {
    ...
    dCertificate(selectukeyInd) {//数字加密证书；
        if (selectukeyInd !== undefined && this.issupport()) {
            this.data.ukey.SetCertIndex(selectukeyInd);
    ...
    startDate(selectukeyInd) {
        if (selectukeyInd !== undefined && this.issupport()) {
            this.data.ukey.SetCertIndex(selectukeyInd);
            return this.data.ukey.GetCertInfo(5)
        }
    },
    endDate(selectukeyInd) {
        if (selectukeyInd !== undefined && this.issupport()) {
            this.data.ukey.SetCertIndex(selectukeyInd);
    ...
    CertType(selectukeyInd) {//个人or机构==0
        if (selectukeyInd !== undefined && this.issupport()) {
            this.data.ukey.SetCertIndex(selectukeyInd);
    ...
    WriteSignDataToKey(WriteSignDataToKeyText) {
        if (this.issupport()) {
            return this.data.KeyManage.WriteSignDataToKey(WriteSignDataToKeyText)
        }
    },
