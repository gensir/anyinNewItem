        ...
        var main = Backbone.View.extend({
            ...
            logout() {
                ...
                bootbox.dialog({
                    ...
                    title: "确认退出？",
                    message:
                        '<div class="msgcenter"><em></em><span>确定现在退出账号吗？</span></div>',
                    buttons: {
                        cancel: {
                            label: "取消",
                            className: "btn1",
                    ...
                    buttons: {
                        ...
                        confirm: {
                            ...
                            callback: function(event) {
                                ...
                                var _this = this;
                                if (numInd == 1) {
                                    var msg4 = dialogsText.find(".msg4")[0]
                                        .outerHTML;
                                    $(this)
                                        .find(".bootbox-body")
                                        .html(msg4);
                                    ...
                                    setTimeout(function() {
                                        if (!ukeys.ukeyName().length) {
                                            ...
                                            var msg6 = dialogsText.find(
                                                ".msg6"
                                            )[0].outerHTML;
                                            $(_this)
                                                .find(".bootbox-body")
                                                .html(msg6);
                                            $.each(ukeys.ukeyName(), function(
                                                ind,
                                                val
                                            ) {
                                                $("#seleBook").append(
                                    ...
                                    if (selectedUkey == "") {
                                        ...
                                        if (
                                            ...
                                            var randomNum = ukeys.randomNum(
                                                randomNumKey,
                                                keyType
                                            );
                                            var PKSC7 = ukeys.dSignature(
                                                selectedUkey,
                                                randomNum
                                            );
